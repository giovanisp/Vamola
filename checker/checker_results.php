...
if (isset($aValidator))
{
	...
	if (is_array($guideline_rows))
	{
		...
		{
			$guidelines_text .= '<a title="'.$row["title"]._AC('link_open_in_new').'" target="info-window" href="'.AC_BASE_HREF.'guideline/view_guideline.php?id='.$row["guideline_id"].'">'.$row["title"]. '</a>, ';
		}
	}
